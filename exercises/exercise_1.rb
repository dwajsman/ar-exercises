...
burnaby = Store.create(annual_revenue: 300000, apparel: ["men", "women"])
richmond = Store.create(annual_revenue: 1260000, apparel: ["women"])
gastown = Store.create(annual_revenue: 190000, apparel: ["men"])
