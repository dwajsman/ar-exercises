...
burnaby = Store.create(name: "Burnaby" ,annual_revenue: 300000, apparel: ["men", "women"])
richmond = Store.create(name: "Richmond" ,annual_revenue: 1260000, apparel: ["women"])
gastown = Store.create(name: "Gastown" ,annual_revenue: 190000, apparel: ["men"])
